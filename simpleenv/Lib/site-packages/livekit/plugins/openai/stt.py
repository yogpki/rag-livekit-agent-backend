...
class STT(stt.STT):
    ...
    def with_groq(
        *,
        model: GroqAudioModels | str = "whisper-large-v3-turbo", #whisper-large-v3-turbo
        api_key: str | None = None,
    ...
    async def _recognize_impl(
        ...
        try:
            config = self._sanitize_options(language=language)
             ...
             # Debug 信息
            print(f"[DEBUG] Sending STT request with language: {config.language}")
            print(f"Initialized STT with model: {self._opts.model}")
            #############
